...
itemnames = c('Mobility','SelfCare','UsualActivities','PainorDiscomfort','Anxietyordepression', # EQ
              'Gettingoutofbed','Puttingonsocks','Gettingupfromsitting','Bendingtowardthefloor_pickinguponobjectfromtheground','Twisting_pivotingontheinjuredknee','Kneeling','Squatting') # KOOS
...
dat2 <- dat2 %>%
 ...
 # questo codice toglie le occasioni con fallimento, non i soggetti
  event_by_id <- dat2 %>%
    transmute(ID,
