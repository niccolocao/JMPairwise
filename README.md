...
In particular, the code implements the pairwise-fitting estimation (Fieuws and Verbeke, 2006) for joint modelling ordinal, continuous, and time-to-event outcomes with dynamic predictions: 
    ...
    Note that the longitudinal outcomes have correlated errors across outcomes.

The code uses GLMMadaptive package for estimation which can be downloaded for the used version by running `remotes::install_github("drizopoulos/GLMMadaptive@36b1b26")`
